...
3. если треки еще не вопроизводились то над прогресс-баром фраза "Music Song".
...
2) язык настроек определяется языком приложения, при переключении языка приложения, язык настроек тоже меняется 
...
Выполненные пункты:
1) время выводится в 24-часовом формате, например: 21:01:00  //todo добавить переключение на 12 часовой формат
...
5) пользователь может ввести своё имя. При перезагрузке страницы приложения имя пользователя сохраняется //todo надо в начале выводить placeholder, а если данные есть, то тогда уже value

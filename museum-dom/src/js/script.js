...
36) Ни на одном из разрешений до 320px включительно не появляется горизонтальная полоса прокрутки,  элементы не должны скрываться, обрезаться, наезжать друг на друга, если это не предусмотрено макетом. 
37) слайдера в секции Welcome
38) слайдера сравнения изображений в секции Explore 
39) кастомного видеоплеера в секции Video 
40) слайдера в секции Video 
41) YouTube-видео в плейлисте в секции Video, маленькие видео выровнены по краям большого 
42) галереи изображений и изображений в ней 
43) карты 
`);